###
###  This is a verbatim copy of the "lock_tests" regression tests from the
###  tandard Python distribution (svn revision 77924 to be precise).  It's
###  included here to support running the standard threading test suite against
###  our new objects.
###
###
